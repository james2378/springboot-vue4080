...
public class ShangpinfenleiController {
    ...
    public R query(ShangpinfenleiEntity shangpinfenlei){
		...
		return R.ok("查询汽车分类成功").put("data", shangpinfenleiView);
    }
    ...
    public R save(@RequestBody ShangpinfenleiEntity shangpinfenlei, HttpServletRequest request){
        if(shangpinfenleiService.selectCount(new EntityWrapper<ShangpinfenleiEntity>().eq("shangpinleixing", shangpinfenlei.getShangpinleixing()))>0) {
            return R.error("汽车类型已存在");
        }
    ...
    public R update(@RequestBody ShangpinfenleiEntity shangpinfenlei, HttpServletRequest request){
        //ValidatorUtils.validateEntity(shangpinfenlei);
        if(shangpinfenleiService.selectCount(new EntityWrapper<ShangpinfenleiEntity>().ne("id", shangpinfenlei.getId()).eq("shangpinleixing", shangpinfenlei.getShangpinleixing()))>0) {
            return R.error("汽车类型已存在");
        }
